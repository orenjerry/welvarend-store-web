...
<main class="min-h-screen w-full flex flex-col" style={`background-color: ${dark_mode['background-primary']}`}>
	<!-- Navbar -->
	...
	<!-- Footer -->
	<footer class="text-white w-full" style={`background-color: ${dark_mode['background-secondary']}`}>
